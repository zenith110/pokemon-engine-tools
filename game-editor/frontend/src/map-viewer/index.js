...
var MapViewer = function () {
    var _a = useState(""), mapImage = _a[0], setMapImage = _a[1];
    return (React.createElement("div", null,
        ...
        React.createElement("button", { onClick: function () { return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, CreateMap()];
                        case 1:
                            map = _a.sent();
                            setMapImage(map);
                            return [2 /*return*/];
        ...
        React.createElement("img", { src: mapImage ? "data:image/png;base64,".concat(mapImage) : '', alt: "" })));
};
