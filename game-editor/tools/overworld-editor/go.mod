module github.com/zenith110/pokemon-engine-tools/tools/overworld-editor
...
require (
	...
	github.com/zenith110/pokemon-go-engine-toml-models v0.0.0-20250223140129-f44c17210e27
)
